...
/*/////////////////////////////////////////////////////*/
   console.log('%c Discord: ', 
            'color: white; background-color: #2274A5', 
            '7859.');
console.log('%c vk.com: ', 
            'color: white; background-color: #95B46A', 
            'https://vk.com/k1ss_lyak');
console.log('%c Авторский доступ: ', 
            'color: white; background-color: #D33F49', 
            'Данный материал используется исключительно в личностных целях.');
