...
const updateTopUpModal = () => {
    setTimeout(() => {
        ...
        <span class="customPayment_inputError">${t['amountMustBeGreatThen100rubels']}</span>
                ...
                <div class="pay-start__bonus-finish" style="    display: flex;width: 100%;margin-top: -10px;padding: 15px;background: rgba(255, 184, 0, 0.1);border-radius: 8px;flex-direction: column;">
