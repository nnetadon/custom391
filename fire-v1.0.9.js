...
</ul><div class="unban" style="background: #333; border-radius: 10px; padding: 20px;"><p class="MsoNormal2" style="font-weight: bold; margin-bottom: 5px;">Возможность разблокировки</p><span>Заявку на разблокировку аккаунта можно подать через года после бана, если вы получили бан по причине читы, макросы и в некоторых случаях игра с читером. Подать заявку можно в свободной форме в группу ВК <a href="vk.com/rust.fire">vk.com/rust.fire</a></span></div></div></div>'
};
