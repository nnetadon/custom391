...
let xaromi = 0;
function *finds() {
    if (document.querySelector('.product') || document.querySelector('.package-complete') || document.querySelector('.colqq'))
        yield++xaromi;
}
